...
public class xFetcherMethod extends xDefaultMethod{
	...
	private synchronized Object synchronized_process()throws xMethodException{
	    ...
	    valid=fetchFile(connection_url,param.toString(),inbox_file);
		//
	    if(valid){
	    	try{
    ...
    private boolean fetchFile(String url_string, String param, File inbox_file)throws xMethodException{
        URL url = null;
        ...
        try {
            ...
            if(valid){
            	...
            	for(int i=0; i< file_count;++i){
            		...
            		xUtility.copyStream(in, file_output, length);
            		file_output.close();
            		file_output=null;
