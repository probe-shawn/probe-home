...
public class uSetProperty extends aDefaultMethod{
		@Override
		public Object process(JSONObject server_jso, String method_name, JSONObject client_jso, JSONObject return_jso) throws aMethodException, JSONException {
			String why="";
			boolean valid=true;
			JSONObject property=client_jso.getJSONObject("arg").getJSONObject("property");
			...
			if(entity == null){
				entity = new Entity("uProperty");
				entity.setProperty("date", new Date());
			}
			JSOToEntity(property, entity);
			ds.put(entity);	
			//
