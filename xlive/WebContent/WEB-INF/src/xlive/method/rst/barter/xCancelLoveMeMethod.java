...
public class xCancelLoveMeMethod extends xDefaultMethod{
	public Object process()throws xMethodException{
		...
		if(valid && my_love_barter != null){
			...
			to.param("method", "set-barter");
			to.param("client-id", this.getArguments("client-id"));
			to.param("mall-fid", my_love_barter.getOwnerFid());
			to.param("mall-name",my_love_barter.getOwnerName());
			to.param("barter-key",my_love_barter.getKey());
			queue.add(to);
			//
			to = TaskOptions.Builder.withUrl("/web/rst/barterchannel");
			to.param("method", "set-barter");
			to.param("client-id", this.getArguments("client-id"));
			to.param("mall-fid", love_me_barter.getOwnerFid());
			to.param("mall-name",love_me_barter.getOwnerName());
			to.param("barter-key",love_me_barter.getKey());
			queue.add(to);
			*/
		}
