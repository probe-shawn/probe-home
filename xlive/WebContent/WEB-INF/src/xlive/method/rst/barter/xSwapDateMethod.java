...
public class xSwapDateMethod extends xDefaultMethod{
	public Object process()throws xMethodException{
		...
		if(entity1 != null && entity2 != null){
			Date date1 = (Date)entity1.getProperty("squDate");
			Date date2 = (Date)entity2.getProperty("squDate");
			...
			if(date1 != null && date2 != null ){
				entity1.setProperty("squDate", date2);
				entity2.setProperty("squDate", date1);
				ds.put(entity1);
				ds.put(entity2);
			}
		}
