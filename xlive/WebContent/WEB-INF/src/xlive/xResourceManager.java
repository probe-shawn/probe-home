...
public class xResourceManager implements xContextObjectImp{
	
	private final String Tag = "xResourceManager";
	private static ServletContext servletContext;
	
	public xResourceManager(ServletContext servlet_context) {
